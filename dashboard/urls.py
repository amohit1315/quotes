...
urlpatterns = [
    ...
    url(r'^filteritem/$',views.filteritem,name='filteritem'),
    url(r'^filterinvoice/$',views.filterinvoice,name='filterinvoice'),
    url(r'^filterquote/$',views.filterquote,name='filterquote'),
    url(r'^view_quote/',views.view_quotes,name='clearquotefilter'),
    url(r'^filterdeliverynotes/',views.filterdeliverynotes,name='filterdeliverynotes'),
    url(r'^view_delivery_note/',views.view_delivery_notes,name='cleardeliverynotesfilter'),
    url(r'^view_invoice/', views.view_invoices, name='clearinvoicefilter'),
    url(r'^view_products/', views.view_product, name='clearitemfilter'),
    url(r'^filtercreditnotes/',views.filtercreditnotes,name='filtercreditnotes'),
    url(r'^view_credit_note/',views.view_credit_notes,name='clearcreditnotesfilter'),
    url(r'^filterpurchaseorder/',views.filterpurchaseorder,name='filterpurchaseorder'),
    url(r'^view_purchase_orders',views.view_purchase_order,name='clearpurchaseorderfilter'),
